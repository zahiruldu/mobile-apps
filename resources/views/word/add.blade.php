    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Add a Word
                ...
                <div class="panel-body">
                   <form class="form-horizontal" role="form" method="POST" action="{{ url('/word/add') }}">
                        ...
                        <div class="form-group{{ $errors->has('ar') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="ar" type="text" class="form-control" name="ar" value="{{ old('ar') }}"  autofocus>
                        ...
                        <div class="form-group{{ $errors->has('en') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="en" type="text" class="form-control" name="en" >
                        ...
                        <div class="form-group{{ $errors->has('bn') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="bn" type="text" class="form-control" name="bn" >
